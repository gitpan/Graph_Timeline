...
This document refers to verion 0.1 of Graph::Timeline::GD, released November 11, 2003

=head1 SYNOPSIS

This subclass produces the GD object of the timeline. The user has to subclass from this class if they want
a GD rendering of the timeline data. By overriding the render_year( ) and render_interval( ) methods the user
can supply a less garish and more pleasing display.
...
Only two methods need to be overridden to create your own GD image of the data. 
